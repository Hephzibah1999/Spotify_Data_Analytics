...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='fd6f6bc00e934e40adbe71e3df16cd80',  # Replace with your Client ID
    client_secret='ea1223124b8a4d3798d8e1955bdc2c6c'  # Replace with your Client Secret
))
...
db_config = {
    ...
    'password': 'Hephzi@23',   # Replace with your MySQL password
